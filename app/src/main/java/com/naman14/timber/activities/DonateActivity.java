...
public class DonateActivity extends BaseThemedActivity implements BillingProcessor.IBillingHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Hỗ trợ phát triển");
    ...
    public void onProductPurchased(String productId, TransactionDetails details) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(DonateActivity.this, "Cảm ơn bạn đã hỗ trợ!", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected void onPostExecute(Boolean b) {
                ...
                if (b) {
                    ...
                    status.setText("Cảm ơn bạn đã hỗ trợ!");
                    if (action!=null && action.equals("restore")) {
                        status.setText("Cảm ơn bạn đã hỗ trợ");
